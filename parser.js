...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'div']]
};
...
const requiredStyles = [
    {
        ...
        properties: [
            ...
            { key: 'justify-content', value: 'space-around' }
        ]
    }
];

const cssTestCase = {
    testCaseName: 'CSS container Styles Test',
    testCaseType: 'boundary',
...
const requiredStyles2 = [
    {
        selector: 'item',
        properties: [
            { key: 'background-color', value: 'lightcoral' },
            { key: 'padding', value: '20px' },
...
const cssTestCase2 = {
    testCaseName: 'CSS item Styles Test',
    testCaseType: 'boundary',
    testLogic: checkCssStyles,
    extraParams: [requiredStyles2]
};

// Define test case for attributes
const htmlAttributesTestCase = {
    testCaseName: 'HTML Attribute Test',
    testCaseType: 'attribute',
    testLogic: checkHtmlAttributes,
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'container' }
    ]]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlAttributesTestCase.testCaseName, htmlAttributesTestCase.testCaseType, htmlAttributesTestCase.testLogic, htmlAttributesTestCase.extraParams);
